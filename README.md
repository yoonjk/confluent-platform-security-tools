...
참조1 : https://github.com/yoonjk/cp-docker-images/blob/5.1.0-post/examples/kafka-cluster-ssl/secrets/create-certs.sh    
참조2 : [SAN 이란](https://ultimatesecurity.pro/post/san-certificate/)
